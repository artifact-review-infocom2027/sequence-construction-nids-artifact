...
def main() -> int:
    ...
    checks = {
        ...
        "task_labels_present": PUBLIC_LABELS.issubset(label_set),
    ...
    result = {
        ...
        "checks": checks,
        "harmonization_self_test": self_json,
    }
    OUTPUTS.mkdir(exist_ok=True)
    (OUTPUTS / "feature_mapping_check.json").write_text(json.dumps(result, indent=2) + "\n", encoding="utf-8")
