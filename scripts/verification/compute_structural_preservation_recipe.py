#!/usr/bin/env python3
"""
Reference implementation for structural-preservation diagnostics.
...
input-driven: users may provide a flow table with the required
columns and reproduce the calculation without access to the original datasets.
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Compute structural-preservation metrics from an input flow table.')
