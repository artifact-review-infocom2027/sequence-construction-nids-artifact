...
Schema harmonization maps dataset-specific columns into a shared feature
interface. The main references are:
...
without embedding local source paths or raw records.

## Label Harmonization

Dataset-specific labels are mapped into the shared label space documented in
