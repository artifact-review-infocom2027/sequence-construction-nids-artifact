...
This directory contains supplementary structural-preservation diagnostics for the submitted transformer-based NIDS paper. The diagnostics compare timestamp-based sliding windows with session-coherent temporalization using the same source-flow universe within each dataset.
