...
class ShallowTextTransformer(nn.Module):
    ...
    It is intentionally compact for recipe validation.
    """
...
class HFWindowClassifierRecipe:
    """Configuration wrapper for Hugging Face window classifiers.

    Model construction is deferred so dry runs do not download external assets.
    """
